...
public class StyleKAndRValidatorTest {
    ...
    @Test
    @DisplayName("Debe lanzar InvalidFormatException si la línea tiene un corchete de apertura inválido")
    ...
    @Test
    @DisplayName("Debe lanzar InvalidFormatException si la línea tiene un corchete de cierre inválido")
    ...
    @Test
    @DisplayName("Debe devolver lanzar InvalidFormatException si existen {} en una sola línea con o sin contenido")

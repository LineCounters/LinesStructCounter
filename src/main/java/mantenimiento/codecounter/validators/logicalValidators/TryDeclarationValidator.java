...
/**
 * Clase que verifica si existe una declaración de un bloque try para poder contabilizarlo como
 * línea lógica
 */
public class TryDeclarationValidator extends LogicalValidator {

  /**
   * Determina si una línea de código corresponde a una declaración de un bloque try para
   * considerarla como línea lógica
   *
   * @param linesOfCode
   * @return {@code true} si la corresponde a una declaración de un bloque try, {@code false} en
   *     caso contrario
   */
  @Override

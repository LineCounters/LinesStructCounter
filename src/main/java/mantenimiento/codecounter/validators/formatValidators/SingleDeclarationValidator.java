...
public class SingleDeclarationValidator extends FormatValidator {
    private static final String MULTIPLE_DECLARATIONS_REGEX = "^\\s*([\\w\\s\\.=\\*&%\\+-/\\^]+(;|,)){2,}\\s*";

    /**
     * Realiza la validacion del formato verificando si existe una sola declaración
     * por línea
     *
     * @param lineOfFile linea de texto (sentencia de codigo) a validar
     * @return {@code true} si la línea cuenta con una sola declaración, {@code false} en caso contrario
    ...
    /**
     * Verifica si la línea contiene múltiples declaraciones separadas por punto y
     * coma o solo por comas.
     *
     * @param lineOfFile La línea del archivo a validar.
     * @return {@code true} si hay múltiples declaraciones separadas por comas o
     *         punto y
     *         coma, {@code false} en caso contrario.
     */
